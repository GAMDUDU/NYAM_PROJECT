...
<script type="text/javascript">
	$(function() {
		...
		var usersearchURL = "../data/SearchUserId.jsp";
		var searchUser = 1;
		...
		$("button[name='user']").click(function() {
			...
			usersearchURL = "../data/SearchUserId.jsp";
		...
		$("button[name='ceo']").click(function() {
			...
			usersearchURL = "../data/SearchCeoId.jsp";
		});
		$("button[name='useridSearch']").click(function() {
			...
			if (usersearchURL == "../data/SearchUserPwd.jsp") {
				usersearchURL = "../data/SearchUserId.jsp";
			} else if (usersearchURL == "../data/SearchCeoPwd.jsp") {
				usersearchURL = "../data/SearchCeoId.jsp";
			}
			searchUser = 1;
		...
		$("button[name='userpwdSearch']").click(function() {
			...
			if (usersearchURL == "../data/SearchUserId.jsp") {
				usersearchURL = "../data/SearchUserPwd.jsp";
			} else if (usersearchURL == "../data/SearchCeoId.jsp") {
				usersearchURL = "../data/SearchCeoPwd.jsp";
			}
			searchUser = 2;
		});
				...
				$.ajax({
					...
					success : function(data) {
						if (data == 0) {
							...
							$().reset();
							location.href = "<%=request.getContextPath() %>/user_login_ok.do?id="+login_id+"&user=member";
						...
						<form class="login_form" onsubmit="return false">
							...
							<div class="col-md-4">
								<input type="text" class="form-control idinput"
									...
									placeholder="아이디" required> <br> <span></span>
							</div>
							<div class="col-md-4">
