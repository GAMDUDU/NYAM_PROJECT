...
<h1>고객 정보 수정</h1>
	...
	<div class = "infobody">
	<form class="row g-3 signup_form" action="<%=request.getContextPath()%>/user_pwd_confirm_ok.do">

						<div class="col-md-4">
							<label for="validationDefault02" class="form-label">비밀번호</label>
							<input type="password" class="form-control" id="user_pwd_confirm"
								value="" name = "pwd" required>
						</div>
						<div class="checkdiv join_check_id">
							<span class="erorcheck" id="user_pwd_confirm_check"></span>
						</div>
