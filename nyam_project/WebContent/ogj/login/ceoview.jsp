...
<body>
                    ...
                    <form action="login_script.php" method="POST">  <%-- 사장님 로그인 --%>
                        <div class="form-group py-2">
                            <div class="input-field"> <span class="far fa-user p-2"></span> <input type="text" placeholder="사업자 번호" required> </div>
                        </div>
                        ...
                        <div class="text-center pt-4 text-muted">등록된 업체가 없습니까? <a href="#">업체 등록</a> </div>
                    </form>
