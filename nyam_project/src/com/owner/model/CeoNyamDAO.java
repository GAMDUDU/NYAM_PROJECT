...
public class CeoNyamDAO {
	...
	//싱글턴 방식
	//instance : 참조변수(주소값)
	private static CeoNyamDAO instance;
	...
	//어디서 생성하든 항상 동일한 주소값
	public static CeoNyamDAO getInstance() {
		if (instance == null) {
			instance = new CeoNyamDAO();
		}
		return instance;
	}	//getInstance() 끝
	...
	//아이디로 DB접근
	public CeoNyamDTO getCeo(String id) {
	...
	//NUM으로 DB접근
	public CeoNyamDTO getCeo(int no) {
		CeoNyamDTO dto = new CeoNyamDTO();
